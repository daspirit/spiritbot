    ...
    class HelpCommands
    {
        public static void SpiritHelpCommands(DiscordClient discord)
        {
            ...
            discord.MessageCreated += async e =>
            {
                ...
                {
                    string commandList = "quote, users [like], whatdo, admin, maintenance"; //also update the spirit help function below
        ...
        public static void SpiritMaintenanceCommands(DiscordClient discord)
        {
                ...
                discord.MessageCreated += async e =>
            {
                ...
                {
                    string commandList = "demote, clear [1-14], addquotes, activeUsers"; //also update the spirit help function below
                    await e.Message.RespondAsync("My current commands, spirit: " + commandList);
                }
            };
            }
